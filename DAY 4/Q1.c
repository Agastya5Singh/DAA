...
int main()
{
    ...
    {
       printf("\n\n 0. Quit the program\n");
        printf("1. Generate n random numbers and store it in an array A[n]\n");
        printf("2. Display the contents of the array A[n]\n");
        printf("3. Sort the Array by using insertion sorting method\n");
        printf("4. Reverse sort the Array by using insertion sorting method\n");
       ...
       printf("5. Display CPU time required to sort the unsorted version of A[n]\n");
        printf("6. Display CPU time required to sort the already sorted version of A[n]\n");
        printf("7. Display CPU time required to sort the reversely sorted version of A[n]\n");
        printf("8. Create a table having 10 rows in the following format for different choices of array A[n] where array size n ranges from 5000 to 50000 with step of 5000\n");
        printf("\n\nChoose any option = ");
        scanf("%d", &t);
        switch (t)
        {
